...
class Calculator:
    def __init__(self,master):
        ...
        master.geometry("357x420+0+0")#sizing of the calculator 
        ...
        #formatting the background of the calculator
        Entry(width=17, bg='aqua', font=('ArialBold, 28'), textvariable=self.equation).place(x=0, y=0)

        #arranging and resizing the buttons or keys of the calculator
        ...
        Button(width=11, height=4, text='=', relief='flat', bg='aqua', command=self.solve).place(x=270 ,y=350)
    ...
    def clear(self):
        self.entry_value=''
        self.equation.set(self.entry_value)
#solving the given maths/operation
    def solve(self):
